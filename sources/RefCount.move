module publisher::adf_ref {
    ...
    const ERROR_INVALID_REFERER: u64 = 6;
    ...
    public entry fun regRef<ADF>(sender: &signer, referer: address) acquires RefProgram{
        ...
        let referBalance = coin::balance<ADF>(referer);
        assert!(referBalance >= MIN_ADX_OF_REFERER, ERROR_INVALID_REFERER);
        assert!(signer::address_of(sender) != referer, ERROR_INVALID_REFERER);
